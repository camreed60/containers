...
: ${AMENT_CURRENT_PREFIX:="/husky_ws/src/install/smartagurdf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/smartagurdf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/smartagurdf/environment/path.sh"
