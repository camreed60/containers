...
: ${AMENT_CURRENT_PREFIX:="/husky_ws/src/install/hardwarelaunch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hardwarelaunch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hardwarelaunch/environment/path.sh"
